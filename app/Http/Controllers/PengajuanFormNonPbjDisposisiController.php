...
class PengajuanFormNonPbjDisposisiController extends Controller
{
    public function index($uuid)
    {
        ...
        return view('pages.pengajuan-form-non-pbj-disposisi.index', [
    ...
    public function create($uuid)
    {
        ...
        return view('pages.pengajuan-form-non-pbj-disposisi.create', [
    ...
    public function store($pengajuan_uuid)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('pengajuan-form-non-pbj.index')->with('success', 'Disposisi Berhasil disimpan.');
        } catch (\Throwable $th) {
            throw $th;
        }
    }
