...
class PengajuanFormNonPbjController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('kabag.pages.form-non-pbj.show', [
    ...
    {
        $item = FormNonPbj::where('id', $id)->firstOrFail();
        return view('kabag.pages.form-non-pbj.edit', [
    ...
    public function update($id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('kabag.form-non-pbj.index')->with('success', 'Pengajuan Form Non PBJ berhasil diubah.');
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
        }
