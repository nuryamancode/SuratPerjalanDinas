...
class SPDSpjDetailController extends Controller
{
    public function create()
    {
        ...
        return view('kabag.pages.spd-spj-detail.create', [
    ...
    public function store()
    {
        ...
        return redirect()->route('kabag.spd-spj.show', $spj->id)->with('success', 'Biaya SPJ berhasil ditambahkan.');
    }

    public function edit($uuid)
    {
        $item = SPJPelaksanaDetail::where('id', $uuid)->firstOrFail();
        return view('kabag.pages.spd-spj-detail.edit', [
            'title' => 'Edit SPJ',
            'item' => $item
        ]);
    }
    ...
    public function update($uuid)
    {
        ...
        $item->update($data);
        return redirect()->route('kabag.spd-spj.show', $item->spj->id)->with('success', 'Biaya SPJ berhasil ditambahkan.');
    }
    ...
    public function destroy($uuid)
    {
        ...
        Storage::disk('public')->delete($item->file);
        $item->delete();
        return redirect()->route('kabag.spd-spj.show', $spj_uuid)->with('success', 'Biaya SPJ berhasil dihapus.');
    }
}
