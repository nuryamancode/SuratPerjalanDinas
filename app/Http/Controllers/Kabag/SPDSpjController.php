...
class SPDSpjController extends Controller
{
    public function index()
    {
        ...
        return view('kabag.pages.spd-spj.index', [
    ...
    public function create()
    {
        ...
        return view('kabag.pages.spd-spj.create', [
    ...
    public function store()
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('kabag.spd-spj.index')->with('success', 'Surat Pertanggung Jawaban Berhasil dibuat.');
        } catch (\Throwable $th) {
            throw $th;
            // DB::rollBack();
    ...
    {
        $item = SPJPelaksana::where('id', $uuid)->firstOrFail();
        return view('kabag.pages.spd-spj.show', [
    ...
    public function print($uuid)
    {
        ...
        // dd($ppk);
        return view('kabag.pages.spd-spj.print', [
