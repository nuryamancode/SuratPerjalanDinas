...
class SuratNonPbjDetailController extends Controller
{
    public function index()
    {
        ...
        return view('wakil-direktur-i.pages.surat-non-pbj-detail.index', [
    ...
    {
        $suratNonPbj = SuratNonPbj::where('uuid', request('surat_non_pbj_uuid'))->firstOrFail();
        return view('wakil-direktur-i.pages.surat-non-pbj-detail.create', [
    ...
    public function store()
    {
        ...
        return redirect()->route('wakil-direktur-i.surat-non-pbj-detail.index', [
    ...
    public function edit($uuid)
    {
        ...
        return view('wakil-direktur-i.pages.surat-non-pbj-detail.edit', [
            'title' => 'Tambah Taksiran',
            'item' => $item
        ]);
    }
