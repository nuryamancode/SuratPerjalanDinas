...
class SpdSpjDetailController extends Controller
{
    public function create()
    {
        ...
        return view('pelaksana-spd.pages.spd-spj-detail.create', [
    ...
    public function store()
    {
        ...
        return redirect()->route('pelaksana-spd.spd-spj.show', $spj->uuid)->with('success', 'Biaya SPJ berhasil ditambahkan.');
    }
    ...
    public function edit($uuid)
    {
        ...
        return view('pelaksana-spd.pages.spd-spj-detail.edit', [
            'title' => 'Edut SPJ',
            'item' => $item
        ]);
    }
    ...
    public function update($uuid)
    {
        ...
        $item->update($data);
        return redirect()->route('pelaksana-spd.spd-spj.show', $item->spj->uuid)->with('success', 'Biaya SPJ berhasil ditambahkan.');
    }
    ...
    public function destroy($uuid)
    {
        ...
        Storage::disk('public')->delete($item->file);
        $item->delete();
        return redirect()->route('pelaksana-spd.spd-spj.show', $spj_uuid)->with('success', 'Biaya SPJ berhasil dihapus.');
    }
}
