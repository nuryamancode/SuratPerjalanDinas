...
class SPDSpjController extends Controller
{
    public function index()
    {
        ...
        return view('timppk.pages.spd-spj.index', [
    ...
    public function create()
    {
        ...
        return view('timppk.pages.spd-spj.create', [
    ...
    public function store()
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('timppk.spd-spj.index')->with('success', 'Surat Pertanggung Jawaban Berhasil dibuat.');
        } catch (\Throwable $th) {
            throw $th;
            // DB::rollBack();
    ...
    {
        $item = SPJPelaksana::where('id', $uuid)->firstOrFail();
        return view('timppk.pages.spd-spj.show', [
    ...
    public function print($uuid)
    {
        ...
        // dd($ppk);
        return view('timppk.pages.spd-spj.print', [
