...
class PengajuanFormNonPbjDetailController extends Controller
{
    public function create()
    {
        ...
        return view('pages.pengajuan-form-non-pbj-detail.create', [
    ...
    public function store()
    {
        ...
        try {
            ...
            return redirect()->route('pengajuan-form-non-pbj.show', $item->uuid)->with('success', 'Detail Pengajuan PBJ Berhasil Ditambahkan.');
        } catch (\Throwable $th) {
            throw $th;
            DB::rollBack();
        }
    ...
    public function edit($uuid)
    {
        ...
        return view('pages.pengajuan-form-non-pbj-detail.edit', [
    ...
    public function update($uuid)
    {
        ...
        try {
            ...
            return redirect()->route('pengajuan-form-non-pbj.show', $item->pengajuan_barang_jasa->uuid)->with('success', 'Detail Pengajuan PBJ Berhasil Diupdate.');
        } catch (\Throwable $th) {
            throw $th;
            DB::rollBack();
        }
    ...
    public function destroy($uuid)
    {
        ...
        try {
            ...
            return redirect()->route('pengajuan-form-non-pbj.show', $item->pengajuan_barang_jasa->uuid)->with('success', 'Detail Pengajuan PBJ Berhasil Dihapus.');
        } catch (\Throwable $th) {
            throw $th;
            DB::rollBack();
        }
