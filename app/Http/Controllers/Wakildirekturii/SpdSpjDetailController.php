...
class SpdSpjDetailController extends Controller
{
    ...
    public function store()
    {
        ...
        return redirect()->route('wakil-direktur-ii.spd-spj.show', $spj->id)->with('success', 'Biaya SPJ berhasil ditambahkan.');
    }
    ...
    public function update($uuid)
    {
        ...
        $item->update($data);
        return redirect()->route('wakil-direktur-ii.spd-spj.show', $item->spj->id)->with('success', 'Biaya SPJ berhasil ditambahkan.');
    }
