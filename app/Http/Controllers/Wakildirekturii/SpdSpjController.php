...
class SpdSpjController extends Controller
{
    ...
    public function store()
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('wakil-direktur-ii.spd.index')->with('success', 'Surat Pertanggung Jawaban Berhasil dibuat.');
        } catch (\Throwable $th) {
            throw $th;
            DB::rollBack();
            return redirect()->route('wakil-direktur-ii.spd.index')->with('error', $th->getMessage());
        }
    }
