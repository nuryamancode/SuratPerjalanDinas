...
class SpdSpjController extends Controller
{
    public function index()
    {
        ...
        return view('wakil-direktur-ii.pages.spd-spj.index', [
    ...
    public function create()
    {
        ...
        return view('wakil-direktur-ii.pages.spd-spj.create', [
    ...
    public function store()
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('wakil-direktur-ii.spd-spj.index')->with('success', 'Surat Pertanggung Jawaban Berhasil dibuat.');
        } catch (\Throwable $th) {
            throw $th;
            // DB::rollBack();
    ...
    {
        $item = SPJPelaksana::where('id', $uuid)->firstOrFail();
        return view('wakil-direktur-ii.pages.spd-spj.show', [
    ...
    public function print($uuid)
    {
        ...
        // dd($ppk);
        return view('wakil-direktur-ii.pages.spd-spj.print', [
