...
class PengajuanFormNonPbjController extends Controller
{
    public function index()
    {
        ...
        return view('wakil-direktur-ii.pages.pengajuan-form-non-pbj.index', [
    ...
    public function create(){
        return view('wakil-direktur-ii.pages.pengajuan-form-non-pbj.create', [
            'title' => 'Pengajuan Form Non PBJ'
        ]);
    }
    ...
    public function store()
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('wakil-direktur-ii.pengajuan-form-non-pbj.index')->with('success', 'Pengajuan Form Non PBJ berhasil ditambahkan.');
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
        }
    ...
    public function show($id)
    {
        ...
        return view('wakil-direktur-ii.pages.pengajuan-form-non-pbj.show', [
    ...
    {
        $item = FormNonPbj::where('id', $id)->firstOrFail();
        return view('wakil-direktur-ii.pages.pengajuan-form-non-pbj.edit', [
    ...
    public function update($id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('wakil-direktur-ii.pengajuan-form-non-pbj.index')->with('success', 'Pengajuan Form Non PBJ berhasil diubah.');
        } catch (\Throwable $th) {
            DB::rollBack();
            throw $th;
        }
