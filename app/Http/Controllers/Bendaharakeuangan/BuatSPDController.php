...
class BuatSPDController extends Controller
{
    public function create($id)
    {
        ...
        return view('bendahara-keuangan.pages.spd.create', [
            'title' => 'Buat SPD',
            'spd' => $spd,
    ...
    public function create_supir($id)
    {
        ...
        return view('bendahara-keuangan.pages.spd.create-supir', [
            'title' => 'Buat SPD',
            'spd' => $spd,
            'selectedKaryawan' => $spd->surat->pelaksana->pluck('karyawan.id')->toArray(),
            'data_karyawan' => Karyawan::orderBy('nama', 'ASC')->get(),
    ...
    public function store()
    {
        ...
        try {
            ...
            return redirect()->route('bendahara-keuangan.permohonan-spd.index')->with('success', 'Surat Perjalanan Dinas Berhasil dibuat.');
        } catch (\Throwable $th) {
            throw $th;
        }
    }
    ...
    public function show($id)
    {
        ...
        return view('bendahara-keuangan.pages.spd.show', [
    ...
    {
        $item = SuratPerjalananDinas::where('id', $id)->firstOrFail();
        return view('bendahara-keuangan.pages.spd.show-supir', [
