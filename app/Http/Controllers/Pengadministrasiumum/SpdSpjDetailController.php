...
class SpdSpjDetailController extends Controller
{
    ...
    public function store()
    {
        ...
        return redirect()->route('pengadministrasi-umum.spd-spj.show', $spj->uuid)->with('success', 'Biaya SPJ berhasil ditambahkan.');
    }
    ...
    public function update($uuid)
    {
        ...
        $item->update($data);
        return redirect()->route('pengadministrasi-umum.spd-spj.show', $item->spj->uuid)->with('success', 'Biaya SPJ berhasil ditambahkan.');
    }
