...
class SpdSpjController extends Controller
{
    public function index()
    {
        ...
        return view('pengadministrasi-umum.pages.spd-spj.index', [
    ...
    public function create()
    {
        ...
        return view('pengadministrasi-umum.pages.spd-spj.create', [
    ...
    public function store()
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('pengadministrasi-umum.spd.index')->with('success', 'Surat Pertanggung Jawaban Berhasil dibuat.');
        } catch (\Throwable $th) {
            throw $th;
        }
    }
    ...
    {
        $item = SPJPelaksana::where('id', $uuid)->firstOrFail();
        return view('pengadministrasi-umum.pages.spd-spj.show', [
    ...
    public function print($uuid)
    {
        ...
        // dd($ppk);
        return view('pengadministrasi-umum.pages.spd-spj.print', [
