...
class SPDPelaksanaController extends Controller
{
    public function index()
    {
        ...
        return view('pengelola-keuangan.pages.spd-pelaksana.index', [
    ...
    public function show($id)
    {
        ...
        return view('pengelola-keuangan.pages.spd-pelaksana.show', [
