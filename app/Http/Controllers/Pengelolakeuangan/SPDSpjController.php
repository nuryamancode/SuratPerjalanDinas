...
class SPDSpjController extends Controller
{
    public function index()
    {
        ...
        return view('pengelola-keuangan.pages.spd-spj.index', [
    ...
    public function create()
    {
        ...
        return view('pengelola-keuangan.pages.spd-spj.create', [
    ...
    public function store()
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('pengelola-keuangan.spd-spj.index')->with('success', 'Surat Pertanggung Jawaban Berhasil dibuat.');
        } catch (\Throwable $th) {
            throw $th;
            // DB::rollBack();
    ...
    {
        $item = SPJPelaksana::where('id', $uuid)->firstOrFail();
        return view('pengelola-keuangan.pages.spd-spj.show', [
    ...
    public function print($uuid)
    {
        ...
        // dd($ppk);
        return view('pengelola-keuangan.pages.spd-spj.print', [
