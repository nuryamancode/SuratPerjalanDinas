                    ...
                    <form action="{{ route('timppk.form-non-pbj-spj.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='text' name='nominal' id='nominal'
                                ...
                                value='{{ $formNonPbj->uang_muka1 ? 'Rp. ' . number_format($formNonPbj->uang_muka1->nominal) : old('nominal') }}'
                                disabled>
                            @error('nominal')
                        ...
                        <div class="form-group text-right">
                            <a href="{{ route('timppk.form-non-pbj.index') }}" class="btn btn-warning">Batal</a>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#formNonPbj_id').on('change', function() {
                let formNonPbj_id = $(this).val();
                $.ajax({
