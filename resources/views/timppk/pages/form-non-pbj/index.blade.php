            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-right">
                        <a href="{{ route('timppk.form-non-pbj.create') }}" class="btn btn-primary btn-sm">
                            Buat Pengajuan
                        </a>
                    </div>
                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->acc_ppk == 2)
                                                <a href="{{ route('timppk.form-non-pbj.edit', $item->id) }}"
                                                    class="btn btn-sm py-2 btn-danger">Edit</a>
                                            @endif
                                            <a href="{{ route('timppk.form-non-pbj.show', $item->id) }}"
