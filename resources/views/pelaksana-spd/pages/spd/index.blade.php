                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->surat_perjalanan_dinas->uang_muka ? 'Rp. ' . number_format($item->surat_perjalanan_dinas->uang_muka->nominal) : '-' }}
                                        </td>
                                        <td>
                                            @if ($item->spj)
                                                <a href="{{ route('pelaksana-spd.spd-spj.show', $item->spj->uuid) }}"
                                                    class="btn btn-info  py-2">Lihat SPJ</a>
                                            @else
                                                <a href="{{ route('pelaksana-spd.spd-spj.create', [
