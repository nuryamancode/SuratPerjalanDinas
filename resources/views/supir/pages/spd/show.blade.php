...
@section('content')
    <div class="row">
        <div class="col-md-8">
            ...
            <a href="{{ route('supir.spd.index') }}" class="back">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-inline">
                        ...
                        <li class="list-item mb-4 d-flex justify-content-between">
                            ...
                            <div>
                                @if ($item->uang_muka)
                                    <a href="{{ route('supir.spd.print', $item->id) }}" target="_blank"
                                        class="btn btn-sm py-2 btn-info">Lihat SPD</a>
                                @endif
                                @if ($item->spj)
                                    <a href="{{ route('supir.spd-spj.show', $item->spj->id) }}"
                                        class="btn btn-info  py-2">Lihat SPJ</a>
                                @else
                                    <a href="{{ route('supir.spd-spj.create', [
                                        'spd_id' => $item->id,
                                    ]) }}"
