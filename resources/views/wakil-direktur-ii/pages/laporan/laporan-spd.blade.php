    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-3">Laporan Surat Perjalanan Dinas</h4>
                        {{-- Form Filter Bulan --}}
                        <form action="{{ route('wakil-direktur-ii.laporan.spd') }}" method="GET" class="mb-3">
                            ...
                            <table class="table table-hover dtTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Kebutuhan Anggaran Pelaksana</th>
                                        <th>Kebutuhan Anggaran Supir</th>
                                        <th>Realisasi</th>
                                        <th>Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($spd as $item)
                                        <tr class="text-center">
                                            ...
                                            <td>{{ $item->disposisi->perihal_1 }}</td>
                                            ...
                                            <td>
                                                <a href="{{ route('wakil-direktur-ii.laporan.spd-show', $item->id) }}" class="btn btn-sm py-2 btn-warning">Detail</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
