    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-3">Laporan Non PBJ Formulir</h4>
                        {{-- Form Filter Bulan --}}
                        <form action="{{ route('wakil-direktur-ii.laporan.form') }}" method="GET" class="mb-3">
                                ...
                                <tbody>
                                    @foreach ($spd as $item)
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a href="{{ route('wakil-direktur-ii.laporan.form-show', $item->id) }}"
