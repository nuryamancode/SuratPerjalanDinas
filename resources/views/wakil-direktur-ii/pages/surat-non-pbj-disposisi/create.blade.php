        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('wakil-direktur-ii.surat-non-pbj-disposisi.store', $item->uuid) }}" method="post"
                        ...
                        <div class="form-group text-right">
                            <a href="{{ route('wakil-direktur-ii.surat-non-pbj.index') }}" class="btn btn-warning">Batal</a>
