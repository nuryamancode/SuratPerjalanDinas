                ...
                <div class="card-body">
                    ...
                    <ul class="list-inline">
                        ...
                        <li class="list-item mb-4 d-flex justify-content-between">
                            <span>Aksi</span>
                            <div>
                                <a href="{{ route('wakil-direktur-i.spd.index') }}"
                            ...
                            <tbody>
                                @foreach ($item->details as $detail)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('wakil-direktur-i.spd-spj-detail.edit', $detail->uuid) }}"
                                            ...
                                            <form action="javascript:void(0)" method="post" class="d-inline"
                                                ...
                                                <button class="btn btnDelete btn-sm py-2 btn-danger"
                                                    data-action="{{ route('wakil-direktur-i.spd-spj-detail.destroy', $detail->uuid) }}">Hapus</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
