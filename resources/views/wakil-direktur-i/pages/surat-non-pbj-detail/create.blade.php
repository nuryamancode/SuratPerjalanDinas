            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mb-3">Tambah Taksiran</h4>
                    </div>
                    ...
                    <form action="{{ route('wakil-direktur-i.surat-non-pbj-detail.store') }}" method="post">
                        @csrf
                        <input type="hidden" name="surat_non_pbj_id" value="{{ $suratNonPbj->id }}">
