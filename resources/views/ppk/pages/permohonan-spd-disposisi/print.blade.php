...
<body onload="window.print()">
    ...
    <div class="line2">
        <div class="checkboxes">
            <input type="checkbox" id="rahasia" name="rahasia" @if ($spd->disposisi->tipe_2 === 'Terbatas Biasa') checked @endif>
            <label for="terbatas_rahasia">Terbatas Biasa</label>
            <input type="checkbox" id="rahasia" name="rahasia" @if ($spd->disposisi->tipe_2 === 'Rahasia') checked @endif>
            <label for="rahasia">Rahasia</label>
            <input type="checkbox" id="terbatas_rahasia" name="terbatas_rahasia"
                @if ($spd->disposisi->tipe_2 === 'Segera') checked @endif>
            <label for="segera">Segera</label>
            <input type="checkbox" id="segera" name="segera" @if ($spd->disposisi->tipe_2 === 'Sangat Segera') checked @endif>
    ...
    <div class="line3">
        <table>
            <tr>
                <td>No. Agenda</td>
                <td>:</td>
                <td>{{ $spd->disposisi->nomor_agenda_2 ?? '-' }}</td>
            </tr>
            <tr>
                <td>No. Surat</td>
                <td>:</td>
                ...
                <tr>
                    <td>
                        <div class="checkboxes-left">
                            ...
                            <label for="arsip">{{ $spd->disposisi->tujuan2->jabatan->nama }}</label>
                        </div>
                    </td>
                </tr>
        </table>
    ...
    <table class="staff" width="100%" style="position: absolute; bottom:10px">
        <tr>
            ...
            <td style="width: 30%">
                <div>{{ $spd->disposisi->pembuat2->jabatan->nama }} <br>
                    Politeknik Negeri Subang
                </div>
                <div style="height:100px;margin-top:10px">
                    @if ($spd->disposisi->pembuat2->tte_file)
                        <img src="{{ $spd->disposisi->pembuat2->tte() }}" alt="" class="img-fluid"
                            style="max-height: 80px">
                    @endif
                </div>
                <div>
                    {{ $spd->disposisi->pembuat2->nama }} <br>
                    NIP. {{ $spd->disposisi->pembuat2->nip }}
                </div>
            </td>
        </tr>
    </table>
