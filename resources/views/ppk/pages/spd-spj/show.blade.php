...
@section('content')
    <div class="row">
        <div class="col-md-4 mb-3">
            ...
            <a href="{{ route('ppk.spd-pelaksana.index') }}" class="back">
                    ...
                    <ul class="list-inline">
                        ...
                        @if ($item->status_spj == 2)
                            <li class="list-item mb-4 d-flex justify-content-between">
                                <span>Aksi</span>
                                <div>
                                    <a href="{{ route('ppk.spd-spj-pelaksana.kirim-ulang', $item->id) }}"
                ...
                <div class="card-body">
                    <div class="d-flex mb-3 justify-content-between">
                        ...
                        @if ($item->status_spj != 1)
                            <a href="{{ route('ppk.spd-spj-detail-pelaksana.create', [
                                'spj_uuid' => $item->id,
                            ]) }}"
                            ...
                            <tbody>
                                @foreach ($item->details as $detail)
                                    <tr>
                                        ...
                                        @if ($item->status_spj != 1)
                                            <td>
                                                <a href="{{ route('ppk.spd-spj-detail-pelaksana.edit', $detail->id) }}"
                                                ...
                                                <form action="javascript:void(0)" method="post" class="d-inline"
                                                    ...
                                                    <button class="btn btnDelete btn-sm py-2 btn-danger"
                                                        data-action="{{ route('ppk.spd-spj-detail-pelaksana.destroy', $detail->id) }}">Hapus</button>
                                                </form>
                                            </td>
                                        @endif
                                        <td>
