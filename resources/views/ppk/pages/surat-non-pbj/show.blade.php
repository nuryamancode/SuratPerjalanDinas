                ...
                <div class="card-body">
                    ...
                    <ul class="list-inline">
                        ...
                        <li class="list-item mb-4 d-flex justify-content-between">
                            ...
                            <span>{{ $item->surat_non_pbj->nomor_agenda ?? '-' }}</span>
                        </li>
                        <li class="list-item mb-4 d-flex justify-content-between">
                            <span>Tanggal</span>
                        ...
                        <li class="list-item mb-4 d-flex justify-content-between">
                            ...
                            <span>{{ $item->surat_non_pbj->nilai_taksiran ? 'Rp. ' . number_format($item->surat_non_pbj->nilai_taksiran, 0, ',', '.') : '-' }}</span>
                        </li>
                        <li class="list-item mb-4 d-flex justify-content-between">
                            <span>Dokumen surat</span>
                            <span>
                                <a href="{{ $item->surat_non_pbj->getFileDokumen() }}" target="_blank" class="btn btn-success btn-sm">Lihat
                                    Dokumen</a>
                            </span>
                        </li>
                        <li class="list-item mb-4 d-flex justify-content-between">
                                ...
                                <div>
                                    <form action="javascript:void(0)" class="d-inline" id="formAcc">
                                        ...
                                        <button class="btn btnAcc btn-sm py-2 btn-success"
                                            data-action="{{ route('ppk.surat-non-pbj-disposisi.index', $item->surat_non_pbj->disposisi_snpbj->id) }}">Terima</button>
                                    </form>
