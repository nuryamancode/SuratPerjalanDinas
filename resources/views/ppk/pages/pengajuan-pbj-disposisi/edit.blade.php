        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('ppk.pengajuan-pbj-disposisi.store', $items->id) }}" method="post"
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='text' name='' id='nomor_surat'
                                ...
                                value='{{ $items->pengajuan_barang_jasa->nomor_surat }}' readonly>
                            @error('nomor_surat')
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='text' name='' id='nomor_agenda'
                                ...
                                value='{{ $items->pengajuan_barang_jasa->nomor_agenda }}' readonly>
                            @error('nomor_agenda')
                                <div class='invalid-feedback'>
                                    {{ $message }}
                                </div>
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='text' name='' id='created_at'
                                ...
                                value='{{ \Carbon\Carbon::parse($items->pengajuan_barang_jasa->created_at)->format('d F Y') }}' readonly>
                            @error('created_at')
                                <div class='invalid-feedback'>
                                    {{ $message }}
                                </div>
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='text' name='' id='created_at'
                                class='form-control @error('created_at') is-invalid @enderror'
                                value='{{ $items->pengajuan_barang_jasa->karyawan->nama }} - {{ $items->pengajuan_barang_jasa->karyawan->jabatan->nama }}' readonly>
                            @error('created_at')
                                <div class='invalid-feedback'>
                                    {{ $message }}
                                </div>
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='text' name='' id='perihal'
                                class='form-control @error('perihal') is-invalid @enderror' value='{{ $items->pengajuan_barang_jasa->perihal }}'
                                readonly>
                            @error('perihal')
                                <div class='invalid-feedback'>
                                    {{ $message }}
