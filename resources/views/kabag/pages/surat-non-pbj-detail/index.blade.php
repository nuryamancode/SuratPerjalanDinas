        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="{{ route('kabag.surat-non-pbj.show', $suratNonPbj->uuid) }}"
                        class="btn my-2 mb-3 btn-sm py-2 btn-warning">Kembali</a>
                    <a href="{{ route('kabag.surat-non-pbj-detail.create', [
                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('kabag.surat-non-pbj-detail.edit', $item->uuid) }}"
                                            ...
                                            <form action="javascript:void(0)" method="post" class="d-inline"
                                                ...
                                                <button class="btn btnDelete btn-sm py-2 btn-danger"
                                                    data-action="{{ route('kabag.surat-non-pbj-detail.destroy', $item->id) }}">Hapus</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
