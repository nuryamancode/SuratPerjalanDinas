        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pengelola-keuangan.buat-spd.store-supir') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id_spd" value="{{ $spd->id  }}">
                        <div class='form-group'>
                            <label for='pelaksana'>Supir</label>
                            <select name='' id=''
                                class='form-control @error('pelaksana') is-invalid @enderror'>
                                <option value='' selected disabled>{{ $spd->surat->supir->nama }}</option>
                            </select>
                            @error('pelaksana')
