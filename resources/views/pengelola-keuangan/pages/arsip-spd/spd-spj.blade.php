                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($item->surat->antar == 1)
                                                <a href="{{ route('pengelola-keuangan.arsip-spd-spj.detail-supir', $item->spd_supir->id) }}"
                                                    class="btn btn-sm py-2 btn-info">Lihat SPJ Supir</a>
                                            @endif
                                            <a href="{{ route('pengelola-keuangan.arsip-spd-spj.detail', $item->spd_pelaksana_dinas->id) }}"
                                                class="btn btn-sm py-2 btn-info">Lihat SPJ Pelaksana</a>
                                            <a href="{{ route('pengelola-keuangan.arsip-spd-spj.show', $item->id) }}"
