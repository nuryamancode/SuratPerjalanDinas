                                ...
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <a href="{{ route('pengelola-keuangan.permohonan-form-non-pbj-disposisi.show', $item->id) }}"
    ...
    <div class="modal fade" id="modalTanggapi{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form
                    action="{{ route('pengelola-keuangan.permohonan-form-non-pbj-disposisi.tanggapi', $item->form_non_pbj->id) }}"
                    method="post">
                    @csrf
                    @method('put')
