<nav class="sidebar sidebar-offcanvas" style="width: 300px" id="sidebar">
    <ul class="nav">
        <li class="nav-item">
            <a class="nav-link py-2" href="{{ route('pengelola-keuangan.dashboard') }}">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="surat">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pengelola-keuangan.spd.index') }}"> Surat Perjalan Dinas </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('pengelola-keuangan.spd-spj.index') }}"> Surat PertanggungJawaban </a>
                    </li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link py-2" href="{{ route('bendahara-keuangan.surat-non-pbj.index') }}">
                <i class="mdi mdi-folder  pr-2 icon-large"></i>
