        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('uang-muka.update', $item->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <div class='form-group mb-3'>
                            ...
                            <input type='text' name='surat_perihal' id='surat_perihal'
                                ...
                                value='{{ $item->spd->surat->perihal ?? old('surat_perihal') }}' readonly>
                            @error('surat_perihal')
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='text' name='surat_nomor_surat' id='surat_nomor_surat'
                                ...
                                value='{{ $item->spd->surat->nomor_surat ?? old('surat_nomor_surat') }}' readonly>
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='text' name='surat_no_agenda' id='surat_no_agenda'
                                ...
                                value='{{ $item->spd->surat->no_agenda ?? old('surat_no_agenda') }}' readonly>
