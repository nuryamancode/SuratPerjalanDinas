...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Edit Detail Pengajuan PBJ</h4>
                    <form action="{{ route('pengajuan-pbj-detail.update', $item->uuid) }}" method="post"
                        ...
                        <div class="form-group text-right">
                            <a href="{{ route('pengajuan-pbj.show', $item->pengajuan_barang_jasa->uuid) }}"
                                class="btn btn-warning">Batal</a>
                            <button class="btn btn-primary">Update Detail Pengajuan PBJ</button>
                        </div>
                    </form>
                </div>
            </div>
