...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Tambah Detail Pengajuan PBJ</h4>
                    <form action="{{ route('pengajuan-pbj-detail.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group text-right">
                            <a href="{{ route('pengajuan-pbj-detail.index') }}" class="btn btn-warning">Batal</a>
                            <button class="btn btn-primary">Tambah Detail Pengajuan PBJ</button>
                        </div>
                    </form>
                </div>
            </div>
