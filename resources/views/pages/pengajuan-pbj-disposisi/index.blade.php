            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="{{ route('pengajuan-pbj.disposisi.create', $pengajuan->uuid) }}"
                            ...
                            <tbody>
                                @foreach ($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <ul>
                                                @foreach ($item->pengajuan_barang_jasa->pelaksana as $pelaksana)
                                            ...
                                            @if ($item->pembuat_karyawan_id == auth()->user()->karyawan->id)
                                                <form action="javascript:void(0)" method="post" class="d-inline"
                                                    ...
                                                    <button class="btn btnDelete btn-sm py-2 btn-danger"
                                                        data-action="{{ route('pengajuan-pbj.disposisi.destroy', $item->id) }}">Hapus</button>
                                                </form>
                                            @endif
                                        </td>
                                    </tr>
