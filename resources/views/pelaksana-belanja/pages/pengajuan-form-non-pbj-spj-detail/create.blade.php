...
@section('content')
    <div class="row">
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Tambah Detail SPJ</h4>
                    <form
                        action="{{ route('pelaksana-belanja.pengajuan-form-non-pbj-spj-detail.store', [
                            'spj_uuid' => $spj->uuid,
                        ]) }}"
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <textarea name='perincian_biaya' id='perincian_biaya' cols='30' rows='3'
                                class='form-control @error('perincian_biaya') is-invalid @enderror'>{{ old('perincian_biaya') }}</textarea>
                        ...
                        <div class="form-group text-right">
                            <a href="{{ route('pelaksana-belanja.pengajuan-form-non-pbj-spj.index') }}"
