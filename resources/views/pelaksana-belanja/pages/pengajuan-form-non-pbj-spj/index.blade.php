        ...
        <div class="col-md">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('pelaksana-belanja.pengajuan-form-non-pbj-spj.store') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="text" name="pengajuan_uuid" value="{{ request('pengajuan_uuid') }}" hidden>
                        <div class='form-group mb-3'>
                            <label for='via' class='mb-2'>Via</label>
                            <input type='text' name='via' id='via'
                                class='form-control @error('via') is-invalid @enderror' value='{{ old('via') }}'>
                            @error('via')
                        ...
                        <div class="form-group text-right">
                            <a href="{{ route('pelaksana-belanja.pengajuan-form-non-pbj.index') }}"
