        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('bendahara-keuangan.uang-muka-spd.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <h6 class="text-center">Uang Muka Supir</h6>
                        <div class='form-group'>
                            ...
                            <input type='text' name='supir' id='supir'
                                ...
                                value='{{ $item->spd->surat->supir->nama ?? old('supir') }}'>
                            @error('supir')
                                <div class='invalid-feedback'>
                                    {{ $message }}
                                </div>
                        ...
                        <div class='form-group mb-3'>
                            ...
                            <input type='number' name='nominal_supir' id='nominal_supir'
                                class='form-control @error('nominal_supir') is-invalid @enderror'
                                value=''>
                            @error('nominal_supir')
                                <div class='invalid-feedback'>
                                    {{ $message }}
