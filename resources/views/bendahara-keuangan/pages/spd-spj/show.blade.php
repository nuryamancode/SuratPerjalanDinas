                    ...
                    <ul class="list-inline">
                        ...
                        @if ($item->status_spj == 2)
                            <li class="list-item mb-4 d-flex justify-content-between">
                                <span>Aksi</span>
                                <div>
                                    <a href="{{ route('bendahara-keuangan.spd-spj.kirim-ulang', $item->id) }}"
                ...
                <div class="card-body">
                    <div class="d-flex mb-3 justify-content-between">
                        ...
                        @if ($item->status_spj != 1)
                            <a href="{{ route('bendahara-keuangan.spd-spj-detail.create', [
                                'spj_uuid' => $item->id,
                            ]) }}"
                            ...
                            <tbody>
                                @foreach ($item->details as $detail)
                                    <tr>
                                        ...
                                        @if ($item->status_spj != 1)
                                            <td>
                                                <a href="{{ route('bendahara-keuangan.spd-spj-detail.edit', $detail->id) }}"
                                                ...
                                                <form action="javascript:void(0)" method="post" class="d-inline"
                                                    ...
                                                    <button class="btn btnDelete btn-sm py-2 btn-danger"
                                                        data-action="{{ route('bendahara-keuangan.spd-spj-detail.destroy', $detail->id) }}">Hapus</button>
                                                </form>
                                            </td>
                                        @endif
                                        <td>
