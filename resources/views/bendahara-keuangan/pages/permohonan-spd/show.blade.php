                ...
                <div class="card-body">
                    ...
                    <ul class="list-inline">
                        ...
                        <li class="list-item mb-4 d-flex justify-content-between">
                            ...
                            <span>
                                <a href="{{ route('bendahara-keuangan.permohonan-spd.print-ppk', $item->id) }}"
                        ...
                        <li class="list-item mb-4 d-flex justify-content-between">
                            ...
                            <div>
                                ...
                                @if ($item->spd_pelaksana_dinas)
                                    <a href="{{ route('bendahara-keuangan.buat-spd.show', $item->id) }}"
                                        class="btn btn-sm py-2 btn-info">Lihat SPD Pelaksana Dinas</a>
                                @else
                                    <a href="{{ route('bendahara-keuangan.buat-spd.create', $item->id) }}"
                                        class="btn btn-sm btn-success">Buat SPD Pelaksana Dinas</a>
                                @endif
                                @if ($item->surat->antar == 1)
                                    @if ($item->spd_supir)
                                        <a href="{{ route('bendahara-keuangan.buat-spd.show-supir', $item->id) }}"
                                            class="btn btn-sm py-2 btn-info">Lihat SPD Supir</a>
                                    @else
                                        <a href="{{ route('bendahara-keuangan.buat-spd.create-supir', $item->id) }}"
