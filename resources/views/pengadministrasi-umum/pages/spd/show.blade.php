                ...
                <div class="card-body">
                    ...
                    <ul class="list-inline">
                        ...
                        <li class="list-item mb-4 d-flex justify-content-between">
                            ...
                            <span>
                                <a href="{{ route('pengadministrasi-umum.permohonan-spd.print-ppk', $item->spd->disposisi->id) }}"
                            ...
                            <div>
                                @if ($item->uang_muka)
                                    @if ($item->spd->surat->antar == 1)
                                        <a href="{{ route('pengadministrasi-umum.spd.print', $item->spd->spd_supir->id) }}"
                                            target="_blank" class="btn btn-sm py-2 btn-info">Lihat SPD Supir</a>
                                    @endif
                                    <a href="{{ route('pengadministrasi-umum.spd.print-pelaksana', $item->id) }}"
