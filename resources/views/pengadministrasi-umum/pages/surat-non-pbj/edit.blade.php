...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-5">Edit Surat Non PBJ</h4>
                    <form action="{{ route('pengadministrasi-umum.surat-non-pbj.update', $item->uuid) }}" method="post"
                        ...
                        <div class="form-group text-right">
                            ...
                            <button class="btn btn-primary">Update Surat Non PBJ</button>
                        </div>
                    </form>
                </div>
            </div>
